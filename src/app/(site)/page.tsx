...
function renderBody(s: HomeSection) {
  ...
  switch (s.kind) {
    ...
    case "pricing":
      /*
        ⚠️ **옵션별 구성표를 여기 두지 않는다** (사용자 지시 2026-08-28).
        카드 아래가 비어 보인다는 지적에 잠깐 넣었다가 `/pricing` 으로 옮겼다 —
        홈은 훑는 자리이고, 항목 일곱 개의 포함 내용을 다 읽는 자리는 요금
        페이지다. 아래 "요금 안내 자세히 보기" 링크가 그 표로 가는 길이다.
      */
      return (
        <>
          <PlanCards />
