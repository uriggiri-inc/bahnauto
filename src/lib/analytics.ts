...
export const GA_MEASUREMENT_ID = "G-5TRWDY543B";

/**
 * GTM 컨테이너 ID. 역시 공개 값이다.
 *
 * 컨테이너는 2026-08 데모 시절 추적 가이드를 따라 만들어졌으나 사이트에는
 * 붙인 적이 없었다 — 2026-09-03 광고 준비(네이버·메타·카카오 픽셀, 전환 태그)를
 * 위해 처음 설치한다.
 *
 ...
 */
export const GTM_CONTAINER_ID = "GTM-T73WDBVS";
