  ...
  sections: [
    ...
    },
    {
      ...
      text: {
        ...
        /*
          "직접 받은" 은 2026-09-08 에 붙였다. 이날 후기가 지어낸 문장 5건에서
          실제 점주 후기 10건으로 바뀌었고(`content/reviews.ts`), 그 사실을
          말하는 자리가 여기다. 형용사가 아니라 사실 진술이라 브랜드 톤
          "약속 대신 사실" 과 맞는다 — 근거가 없어지면 이 말도 함께 뺀다.
        */
        lead: "우리끼리 무인키즈카페에서 반오토를 이용 중인 점주들에게 직접 받은 후기입니다.",
      },
      style: { titleSize: "h1", padY: "md", bg: "white", align: "left" },
    },
    {
