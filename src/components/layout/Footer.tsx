  ...
  },
  {
    ...
    links: [
      /*
        ...
        **외부 주소**이므로 `external` 로 표시한다.

        사이트 안에 있던 `/company` 페이지는 **2026-09-07 지웠다.** 이 링크와 홈의
        "회사 소개" 버튼이 둘 다 밖으로 나가면서 들어갈 입구가 없어졌기 때문이다.
        이제 "회사 소개" 는 사이트 어디에서든 uriggiri.kr 한 곳을 가리킨다.
      */
